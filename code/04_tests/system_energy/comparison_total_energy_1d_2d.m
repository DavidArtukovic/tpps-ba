...
% --- 1D model
plot(t_h_1d(1:Nplot_1d), E_sys_1d(1:Nplot_1d), ...
    'k-', 'LineWidth', 1.6);

plot(t_h_1d(1:Nplot_1d), E_flow_true_1d(1:Nplot_1d), ...
    'k--', 'LineWidth', 1.6);

plot(t_h_1d(1:Nplot_1d), E_flow_simple_1d(1:Nplot_1d), ...
    'Color', [0.35 0.35 0.35], 'LineStyle', ':', 'LineWidth', 1.2);

% --- 2D model
plot(t_h_2d(1:Nplot_2d), E_sys_2d(1:Nplot_2d), ...
    'r-', 'LineWidth', 1.6);

plot(t_h_2d(1:Nplot_2d), E_flow_true_2d(1:Nplot_2d), ...
    'r--', 'LineWidth', 1.6);

plot(t_h_2d(1:Nplot_2d), E_flow_simple_2d(1:Nplot_2d), ...
    'Color', [0.85 0.35 0.35], 'LineStyle', ':', 'LineWidth', 1.2);
...
legend( ...
    '\DeltaE_{sys} - MATLAB 1D', ...
    'E_{flow,true} - MATLAB 1D', ...
    'E_{flow,simple} - MATLAB 1D', ...
    '\DeltaE_{sys} - MATLAB 2D piston', ...
    'E_{flow,true} - MATLAB 2D piston', ...
    'E_{flow,simple} - MATLAB 2D piston', ...
    'Location', 'best');
...
plot(t_h_1d(1:Nplot_1d), res_true_1d(1:Nplot_1d), ...
    'k-', 'LineWidth', 1.6);

plot(t_h_1d(1:Nplot_1d), res_simple_1d(1:Nplot_1d), ...
    'Color', [0.35 0.35 0.35], 'LineStyle', '--', 'LineWidth', 1.2);

plot(t_h_2d(1:Nplot_2d), res_true_2d(1:Nplot_2d), ...
    'r-', 'LineWidth', 1.6);

plot(t_h_2d(1:Nplot_2d), res_simple_2d(1:Nplot_2d), ...
    'Color', [0.85 0.35 0.35], 'LineStyle', '--', 'LineWidth', 1.2);
...
legend( ...
    'R_{true} - MATLAB 1D', ...
    'R_{simple} - MATLAB 1D', ...
    'R_{true} - MATLAB 2D piston', ...
    'R_{simple} - MATLAB 2D piston', ...
    'Location', 'best');
...
%           outflow at top   = T_top
    ...
    E_flow_true   = [0, cumsum(dE_true)];
    E_flow_simple = [0, cumsum(dE_simple)];
end