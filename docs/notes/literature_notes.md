...
**Key idea:**  
Dynamic time-dependent model of the TPPS system focusing on charge/discharge cycles.
...
<!-- **Relevant equations:**   -->
- 1D water heat transport equation 
...
## Schäfer et al. (2021) – Zero-Energy Sauna
**Key idea:**  
